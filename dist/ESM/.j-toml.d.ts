...
export const parse :
	& {
		   <CustomValue                                                  > (this :void, source :Source, specificationVersion :1.0, multilineStringJoiner :string, useBigInt  :boolean | number     , xOptions :TagProcessor<CustomValue> | { readonly tag :TagProcessor<CustomValue>, readonly null? :boolean } & TypeAgnosticOptions/* = false */) :Table<CustomValue>;
...
declare const exports :Readonly<{
	...
	Section :typeof Section, inline :typeof inline, multiline :typeof multiline, multilineBasicString :typeof multilineBasicString, multilineString :typeof multilineString, literal :typeof literal,
	OffsetDateTime :typeof OffsetDateTime, LocalDateTime :typeof LocalDateTime, LocalDate :typeof LocalDate, LocalTime :typeof LocalTime,
