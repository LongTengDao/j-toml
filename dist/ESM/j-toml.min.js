...
`.valueOf(),HMS=newRegExp`
	${_23_}:${_59_}:${_59_}
`.valueOf(),OFFSET$=/(?:Z|[+-]\d\d:\d\d)$/,{exec:Z_exec}=theRegExp(/(([+-])\d\d):(\d\d)$/),{exec:OFFSET_DATETIME_exec}=newRegExp`
	^
	${YMD}
	[T ]
	${HMS}
