...
`.valueOf(),{test:BAD_DXOB}=newRegExp`_(?![\dA-Fa-f])`.valueOf(),isAmazing=e=>IS_AMAZING(e)&&!BAD_DXOB(e);let preserveLiteral,zeroDatetime,inlineTable,moreDatetime,disallowEmptyKey,sError,sFloat,Table,allowLonger,enableNull,allowInlineTableMultilineAndTrailingCommaEvenNoComma,preserveComment,disableDigit,mustScalar=!0,useWhatToJoinMultilineString=null,usingBigInt=!0,IntegerMinNumber=0n,IntegerMaxNumber=0n;const arrayTypes=new WeakMap$1,arrayTypes_get=get.bind(arrayTypes),arrayTypes_set=set.bind(arrayTypes),As=()=>{const e=t=>{const r=arrayTypes_get(t);return r?r===e||throws(TypeError$1("Types in Array must be same"+where(". Check "))):arrayTypes_set(t,e),t};return e},AS_TYPED={asNulls:As(),asStrings:As(),asTables:As(),asArrays:As(),asBooleans:As(),asFloats:As(),asIntegers:As(),asOffsetDateTimes:As(),asLocalDateTimes:As(),asLocalDates:As(),asLocalTimes:As()},asMixed=e=>e;let asNulls,asStrings,asTables,asArrays,asBooleans,asFloats,asIntegers,asOffsetDateTimes,asLocalDateTimes,asLocalDates,asLocalTimes,processor=null,collection=[],collection_length=0;const collect_on=(e,t,r,n)=>{const i=create(NULL);i.tag=e,r&&(i.table=r,i.key=n),t&&(i.array=t,i.index=t.length),collection[collection_length++]=i},collect_off=()=>{throw throws(SyntaxError$1("xOptions.tag is not enabled, but found tag syntax"+where(" at ")))};let collect=collect_off;const Process=()=>{if(collection_length){let e=collection_length;const t=processor,r=collection;return collection=[],()=>{do{t(r[--e]),r.length=e}while(e)}}return null},clear=()=>{processor=null,collection.length=collection_length=0,zeroDatetime=!1,useWhatToJoinMultilineString=null},use=(e,t,r,n)=>{let i;switch(e){case 1:mustScalar=i=moreDatetime=sFloat=inlineTable=!0,zeroDatetime=disallowEmptyKey=!1;break;case.5:mustScalar=moreDatetime=sFloat=inlineTable=!0,i=zeroDatetime=disallowEmptyKey=!1;break;case.4:mustScalar=disallowEmptyKey=inlineTable=!0,i=zeroDatetime=moreDatetime=sFloat=!1;break;case.3:mustScalar=disallowEmptyKey=!0,i=zeroDatetime=moreDatetime=sFloat=inlineTable=!1;break;case.2:case.1:zeroDatetime=disallowEmptyKey=!0,mustScalar=i=moreDatetime=sFloat=inlineTable=!1;break;default:throw RangeError$1("TOML.parse(,specificationVersion)")}if(switchRegExp(e),"string"==typeof t)useWhatToJoinMultilineString=t;else{if(t!==undefined$1)throw TypeError$1("TOML.parse(,,multilineStringJoiner)");useWhatToJoinMultilineString=null}if(r===undefined$1||!0===r)usingBigInt=!0;else if(!1===r)usingBigInt=!1;else{if("number"!=typeof r)throw TypeError$1("TOML.parse(,,,useBigInt)");if(!isSafeInteger(r))throw RangeError$1("TOML.parse(,,,useBigInt)");usingBigInt=null,r>=0?IntegerMinNumber=-(IntegerMaxNumber=BigInt$1(r)):IntegerMaxNumber=-(IntegerMinNumber=BigInt$1(r))-1n}if(null==n)Table=PlainTable,sError=allowLonger=enableNull=allowInlineTableMultilineAndTrailingCommaEvenNoComma=!1,collect=collect_off;else{if("object"!=typeof n)throw TypeError$1("TOML.parse(,,,"+typeof n);{const{order:e,longer:t,exact:r,null:a,multi:s,comment:l,string:o,literal:c,tag:_,...u}=n,E=getOwnPropertyNames(u);if(E.length)throw TypeError$1(`TOML.parse(,,,,{ ${E.join(", ")} })`);if(Table=e?OrderedTable:PlainTable,allowLonger=!t,sError=!!r,enableNull=!!a,allowInlineTableMultilineAndTrailingCommaEvenNoComma=!!s,preserveComment=!!l,disableDigit=!!o,preserveLiteral=!!c,_){if("function"!=typeof _)throw TypeError$1("TOML.parse(,,,,xOptions.tag)");if(!i)throw TypeError$1("TOML.parse(,,,,xOptions) xOptions.tag needs at least TOML 1.0 to support mixed type array");processor=_,collect=collect_on}else collect=collect_off}}i?asNulls=asStrings=asTables=asArrays=asBooleans=asFloats=asIntegers=asOffsetDateTimes=asLocalDateTimes=asLocalDates=asLocalTimes=asMixed:({asNulls,asStrings,asTables,asArrays,asBooleans,asFloats,asIntegers,asOffsetDateTimes,asLocalDateTimes,asLocalDates,asLocalTimes}=AS_TYPED)},Symbol$1=Symbol,previous=Symbol$1("previous"),x=e=>{let t=e,r=t.next();if(!r.done)for(r.value[previous]=t,r=(t=r.value).next();;)if(r.done){if(t===e)break;t=t[previous],r=t.next(r.value)}else r.value[previous]=t,r=(t=r.value).next();return r.value},_literal=Symbol$1("_literal"),LiteralObject=(e,t)=>{const r=Object$1(t);return r[_literal]=e,r},arrays=new WeakSet$1,arrays_add=add.bind(arrays),isArray=has.bind(arrays),OF_TABLES=!1,STATICALLY=!0,staticalArrays=new WeakSet$1,staticalArrays_add=add.bind(staticalArrays),isStatic=has.bind(staticalArrays),newArray=e=>{const t=[];return arrays_add(t),e&&staticalArrays_add(t),t},NativeDate=Date,parse$2=Date.parse,preventExtensions=Object.preventExtensions,getOwnPropertyDescriptors=Object.getOwnPropertyDescriptors,defineProperties=function(e,t){for(var r=create(NULL),n=keys(t),i=n.length,a=0;a<i;++a){var s=n[a];r[s]=Descriptor(t[s])}if(getOwnPropertySymbols){var l=getOwnPropertySymbols(t);for(i=l.length,a=0;a<i;++a){var o=l[a];isEnum(t,o)&&(r[o]=Descriptor(t[o]))}}return Object_defineProperties(e,r)},fpc=e=>(freeze(freeze(e).prototype),e),_29_=/(?:0[1-9]|1\d|2\d)/,_30_=/(?:0[1-9]|[12]\d|30)/,_31_=/(?:0[1-9]|[12]\d|3[01])/,_23_=/(?:[01]\d|2[0-3])/,_59_=/[0-5]\d/,YMD=newRegExp`
	\d\d\d\d-
	(?:
		0
		(?:
